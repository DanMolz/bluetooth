...
// This is the base for representing 16 bit UUID as 128 bit UUIDs. The relevant
// 16 bits will be encoded as 'xxxx' in:
// 0000xxxx-0000-1000-8000-00805F9B34FB
// https://www.bluetooth.com/specifications/assigned-numbers/service-discovery/
const base16BitUUID string = "00000000-0000-1000-8000-00805f9b34fb"
...
// "00001234-0000-1000-8000-00805f9b34fb" format (128 bit) or "abcd" (16 bit).
// If the UUID cannot be parsed, an error is returned. It will always successfully
// parse UUIDs generated by UUID.String().
func ParseUUID(s string) (uuid UUID, err error) {
	// A 16bit UUID, encoded as a 4-char string.
	if len(s) == 4 {
		base, err := ParseUUID(base16BitUUID)
		if err != nil {
			return uuid, err
		}
		converted, err := strconv.ParseUint(s, 16, 16)
		if err != nil {
			return uuid, err
		}
		return base.Replace16BitComponent(uint16(converted)), nil
	}
